...
#### Day 11-13: RabbitMQ 이벤트 시스템 구축

**목표**: 이벤트 기반 아키텍처 보일러플레이트 완성
...
1. **이벤트 모듈 생성**
   ...
   @Module({
     ...
     exports: [EventEmitterModule, ClientsModule],
   })
...
#### Day 14-15: 공통 유틸리티 및 헬퍼 함수

**목표**: 재사용 가능한 유틸리티 함수 작성
